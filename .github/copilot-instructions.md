# Copilot Instructions for lxRAG-MCP

MCP server for code graph intelligence, agent memory, and multi-agent coordination — for VS Code Copilot, Claude Code, Claude Desktop, and Cursor.
