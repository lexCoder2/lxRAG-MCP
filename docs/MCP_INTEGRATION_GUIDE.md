...
Complete guide for integrating lexRAG MCP across projects.
...
Claude/Copilot Chat
    ↓ (MCP tools only)
    ↓
lexRAG MCP Server (http://localhost:9000)
    ↓         ↓
Memgraph   Qdrant
(graph)    (vectors)
